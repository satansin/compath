...
--
-- Table structure for table `pic_message`
--

DROP TABLE IF EXISTS `pic_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pic_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `time` bigint(20) DEFAULT NULL,
  ...
  `group_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pic_message_group1_idx` (`group_id`),
  KEY `fk_pic_message_user1_idx` (`sender_id`),
  CONSTRAINT `fk_pic_message_group1` FOREIGN KEY (`group_id`) REFERENCES `group` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pic_message_user1` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pic_message`
--

LOCK TABLES `pic_message` WRITE;
/*!40000 ALTER TABLE `pic_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `pic_message` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-03 21:14:18
